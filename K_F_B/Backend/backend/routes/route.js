...
router.route('/user').get(authmiddleware , userController.myuser);
...
router.route('/GetCartData/:id').get(productController.CartData)
router.route('/UpdateCartQuantity').post(productController.UpdateCartQuantity)
router.route('/RemoveCartProduct').post(productController.RemoveCartProduct)
